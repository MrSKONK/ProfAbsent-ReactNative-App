...
- `app/_layout.tsx` — Déclare la pile de navigation (Stack) sans header, inclut les routes: `index` (splash logique), `onboarding`, `login`, `register`, `diagnostic`, `(tabs)`, `manager`.
